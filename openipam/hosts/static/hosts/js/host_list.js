$(function(){
    ...
    var results = $("#result_list").DataTable({
        ...
        "columns": [
            ...
            { "name": "mac_last_seen", "orderable": false },
            { "name": "ip_last_seen", "orderable": false },
            { "name": "dns_records", "orderable": false },
    ...
    $(".search_init").on('input', function(e) {
        ...
        var self = this;
        delay(function(){
            results.column($(".search_init").index($(self))+1).search($(self).val()).draw();
        }, 300);
    });
