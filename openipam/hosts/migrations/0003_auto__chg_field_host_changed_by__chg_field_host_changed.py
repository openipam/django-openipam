...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Host.changed_by'
        db.alter_column('hosts', 'changed_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], db_column='changed_by'))

        # Changing field 'Host.changed'
        db.alter_column('hosts', 'changed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 5, 29, 0, 0)))

    def backwards(self, orm):

        # Changing field 'Host.changed_by'
        db.alter_column('hosts', 'changed_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user.User'], db_column='changed_by'))

        # Changing field 'Host.changed'
        db.alter_column('hosts', 'changed', self.gf('django.db.models.fields.DateTimeField')(null=True))
