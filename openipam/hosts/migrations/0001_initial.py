    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host', models.ForeignKey(db_column=b'mac', on_delete=django.db.models.deletion.CASCADE, related_name='freeform_attributes', to='hosts.Host', to_field='mac')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_permissions', models.ForeignKey('Permission', db_column=b'min_permissions', on_delete=django.db.models.deletion.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('changed', models.DateTimeField(auto_now=True)),
                ('host', models.ForeignKey('Host', db_column=b'mac', to_field='mac', on_delete=django.db.models.deletion.CASCADE, related_name='structured_attributes')),
                ('changed_by', models.ForeignKey(db_column=b'changed_by', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
