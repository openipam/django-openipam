...
urlpatterns = [
    ...
    path("dnsrecord/add/", RedirectView.as_view(url=reverse_lazy("core:dns:add_dns"))),
    path("dnsrecord/<int:pk>/", RedirectView.as_view(pattern_name="core:dns:edit_dns")),
    path("dnsrecord/", RedirectView.as_view(url=reverse_lazy("core:dns:list_dns"))),
    re_path(
