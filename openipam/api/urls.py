...
urlpatterns = [
    ...
    path("web/", include("autocomplete_light.urls")),
    # Reports
    path(
        "reports/serverhosts/",
    ...
    path("domains/", views.dns.DomainList.as_view(), name="api_domain_list"),
    re_path(
        r"^domains?/name/$",
    ...
    path("mac/recent/", views.hosts.RecentGulMacEntries.as_view(), name="api_gul_macs"),
    path(
