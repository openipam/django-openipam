...
urlpatterns = [
    ...
    url(r'^network/(?P<pk>(\d{0,3}\.\d{0,3}\.\d{0,3}\.\d{0,3}\/\d{0,2}))/$', views.network.NetworkDetail.as_view(), name='api_network_detail'),
    url(r'^network/add/$', views.network.NetworkCreate.as_view(), name='api_network_create'),
    url(r'^network/(?P<pk>(\d{0,3}\.\d{0,3}\.\d{0,3}\.\d{0,3}\/\d{0,3}))/update/$', views.network.NetworkUpdate.as_view(), name='api_network_update'),
    url(r'^network/(?P<pk>(\d{0,3}\.\d{0,3}\.\d{0,3}\.\d{0,3}\/\d{0,3}))/delete/$', views.network.NetworkDelete.as_view(), name='api_network_delete'),
