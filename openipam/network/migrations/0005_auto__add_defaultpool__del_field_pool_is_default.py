...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'network_defaultpool', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pool', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pool_defaults', to=orm['network.Pool'])),
            ('cidr', self.gf('netfields.fields.CidrAddressField')(max_length=43)),
        ))
        db.send_create_signal(u'network', ['DefaultPool'])

        # Deleting field 'Pool.is_default'
        db.delete_column('pools', 'is_default')


    def backwards(self, orm):
        # Deleting model 'DefaultPool'
        db.delete_table(u'network_defaultpool')

        # Adding field 'Pool.is_default'
        db.add_column('pools', 'is_default',
    ...
    models = {
        ...
        u'network.defaultpool': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pool': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pool_defaults'", 'to': u"orm['network.Pool']"})
        },
        u'network.dhcpgroup': {
