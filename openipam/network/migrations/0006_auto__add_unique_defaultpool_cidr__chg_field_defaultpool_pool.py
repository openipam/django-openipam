...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'DefaultPool', fields ['cidr']
        db.create_unique(u'network_defaultpool', ['cidr'])


        # Changing field 'DefaultPool.pool'
        db.alter_column(u'network_defaultpool', 'pool_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['network.Pool']))

    def backwards(self, orm):
        # Removing unique constraint on 'DefaultPool', fields ['cidr']
        db.delete_unique(u'network_defaultpool', ['cidr'])


        # Changing field 'DefaultPool.pool'
        db.alter_column(u'network_defaultpool', 'pool_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['network.Pool']))
    ...
    models = {
        ...
        u'hosts.host': {
            ...
            'changed_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'db_column': "'changed_by'"}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        u'network.defaultpool': {
            'Meta': {'object_name': 'DefaultPool'},
            'cidr': ('netfields.fields.CidrAddressField', [], {'unique': 'True', 'max_length': '43'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pool': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pool_defaults'", 'null': 'True', 'to': u"orm['network.Pool']"})
        },
        u'network.dhcpgroup': {
