...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('users', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'User.last_name'
        db.alter_column('users', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'User.email'
        db.alter_column('users', 'email', self.gf('django.db.models.fields.EmailField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'User.first_name'
        db.alter_column('users', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'User.last_name'
        db.alter_column('users', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'User.email'
        db.alter_column('users', 'email', self.gf('django.db.models.fields.EmailField')(max_length=254))
