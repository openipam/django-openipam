...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'user.internalauth': {
            ...
            'id': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'internal_user'", 'primary_key': 'True', 'db_column': "'id'", 'to': u"orm['auth.User']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'})
        },
        ...
        u'user.usertogroup': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_groups'", 'db_column': "'uid'", 'to': u"orm['auth.User']"})
        }
    }
