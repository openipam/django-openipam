...
import { requestGenerator as RequestGenerator, HttpMethod } from "./index";

export class Host implements datatypes.HostData.GetData {
  mac!: string;
  hostname!: string;
  expires!: string;
  description!: string | null;
  is_dynamic!: boolean;
  disabled_host!: Required<Omit<datatypes.DisabledHostData, "disabled">> | null;
  dhcp_group!: datatypes.DHCPGroupData | null;
