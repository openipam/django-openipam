    ...
    >
      ...
      <Show when={!loaded}>
        <div className="flex flex-col">
          ...
          <p className="my-1">
            Only mac, hostname, and address type are required. Expire_days will
            default to 7 if left blank, and user_owner will default to your user
            if no user or group owner is given.
          </p>
          <p>
            Please double check all records to ensure addresses are valid, and
            non-dynamic types given either network or ip address, and that it is
            valid for the given address type.
          </p>
        </div>
      </Show>
