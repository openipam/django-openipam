...
class AutocompleteGenericMetaClass(type):
    def __new__(cls, name, bases, attrs):
        new_class = super(AutocompleteGenericMetaClass, cls).__new__(
            cls, name, bases, attrs
        )

        if attrs.get("__module__", "").startswith("autocomplete_light.autocomplete"):
...
class AutocompleteGeneric(
    six.with_metaclass(AutocompleteGenericMetaClass, AutocompleteModel)
):
    """
