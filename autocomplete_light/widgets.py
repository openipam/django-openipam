...
class WidgetBase(object):
    ...
    def __init__(
        ...
        if autocomplete_js_attributes is not None:
            raise PendingDeprecationWarning(
                "autocomplete_js_attributes are" "deprecated in favor of attrs"
            )

        if widget_js_attributes is not None:
            raise PendingDeprecationWarning(
                "widget_js_attributes are" "deprecated in favor of widget_attrs"
            )
    ...
    def build_attrs(self, attrs, extra_attrs=None, autocomplete=None, **kwargs):
        ...
        attrs.setdefault(
            "data-autocomplete-url", self.autocomplete().get_absolute_url()
        )
        attrs.setdefault(
...
class TextWidget(WidgetBase, forms.TextInput):
    ...
    def build_attrs(self, attrs, extra_attrs=None, autocomplete=None, **kwargs):
        ...
        attrs.update(getattr(autocomplete, "attrs", {}))
        attrs.update(
            super(TextWidget, self).build_attrs(self.attrs, extra_attrs, **kwargs)
        )
